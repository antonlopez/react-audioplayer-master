...
const HOCAudio = Audio => class HOCAudioComponent extends React.Component {
  static propTypes = {
  ...
  constructor(props) {
    ...
    if (this.props.fullPlayer) {
      ...
      // bind methods
      // this.playNext = props.recordButton2; // A boolean to determine whether to play the next song or not
